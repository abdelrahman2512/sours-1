...
ob_start();
$API_KEY = '5359234718:AAGaJlvU1f1obE95NONjv0UJJSOz7MOh8uw'; //add your bot token
...
$uphoto = "https://id.heroku.com/login"; // رابط استضافتك
bot("sendPhoto",[
'chat_id'=>$chat_id,
"photo"=>$uphoto,
'caption'=>"
...
$path = $pa->result->file_path;
file_put_contents("$rnd.jpg",file_get_contents("https://api.telegram.org/file/bot".$API_KEY."/".$path));
$uphoto = "https://dev-body2005.pantheonsite.io"; // رابط استضافتك
bot("sendPhoto",[
'chat_id'=>$chat_id,
"photo"=>$uphoto,
'caption'=>" ",
